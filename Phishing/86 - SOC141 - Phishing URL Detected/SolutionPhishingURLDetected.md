...
- Un score VirusTotal de 12/97 est suffisant pour considérer une URL comme suspecte dans un contexte SOC. Il ne faut pas forcément attendre une majorité de détections
